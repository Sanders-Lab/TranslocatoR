...
Simply run `devtools::install_github(repo = "https://github.com/Sanders-Lab/TranslocatoR", ref = "master")`, load the TranslocatoR library with `library(TranslocatoR)` and you're ready to go. Alternatively clone the repo and work from there: `git clone --recurse-submodules https://github.com/Sanders-Lab/TranslocatoR.git`. Have fun!
